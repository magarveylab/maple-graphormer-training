...
def compile_model(
    pytorch_checkpoint_fp: str = f"{experiment_dir}/MS2-chemotype/checkpoints/last.pt",
    torchscript_dir: str = f"{experiment_dir}/MS2-chemotype/torchscript",
...
parser = argparse.ArgumentParser(
    description="Convert MS2Former model (for chemotype embeddings) to torchscript format"
)
parser.add_argument(
    "-torchscript_dir",
    help="Directory to save torchscript models",
    default=f"{experiment_dir}/MS2-chemotype/torchscript",
)
parser.add_argument(
